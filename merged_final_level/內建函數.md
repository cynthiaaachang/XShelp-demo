...
title: XS完整手冊 - 內建函數
category: 內建函數
tags: [XS語法, 內建函數, Factorial, GetBackBar, FilledAvgPrice, UpperStr, GetFieldPublishDate, CurrentBar, TimeValue, FilledRecordCount, IsLastBar, MidStr, FilledRecordIsRealtime, Combination, Buy, FilledRecordPrice, SetFirstBarDate, SetBackBar, WeekOfYear, TimeToString, Array_Sort2d, Tangent, SetBarFreq, GetSymbolFieldStartOffset, CallFunction, GetSymbolGroup, Year, FilledRecordTime, CurrentDate, FormatDate, GetSymbolField, GetSymbolFieldDate, Array_GetMaxIndex, SymbolExchange, AddSpread, Array_SetValRange, GetTotalBar, DateAdd, Permutation, EncodeDate, GetBarBack, Random, DataAlign, StrCompare, DefaultBuyPrice, NoPlot, StrLen, Square, GetTBMode, Tan, LeftStr, SetTBMode, MinList2, RaiseRunTimeError, BarInterval, SetPlotLabel, ArcTangent, FilledRecordQty, DayOfWeek, Sign, ExpValue, GetBarOffset, LowerStr, DefaultSellPrice, NthMinList, EncodeTime, Array_Compare, IsSessionLastBar, InStr, Minute, Plot, Market, PlotLine, AvgList, NumToStr, Position, StringToDate, OutputField, FilledAtBroker, SetRemoveOutlier, PlotFill, CurrentTimeMS, DateDiff, Sin, FormatTime, Second, CheckSymbolField, Array_GetType, GetQuote, StringToTime, SymbolType, StrEndWith, ArcSine, DateToString, CancelAllOrders, SymbolName, SetPosition, IsFirstCall, Mod, FilledRecordTimeMS, IsSessionFirstBar, Floor, Filled, MinList, Round, Sell, GetFieldDate, StrToNum, TimeDiff, Hour, Month, BarFreq, Array_Sum, StrStartWith, Array_Copy, Ceiling, DayOfMonth, Cos, Pos, GetInfo, SetInputName, IsSupportField, SetTotalBar, Print, PlotK, FilledEntryTimeMS, RightStr, CheckField, FilledRecordBS, IsSupportSymbolField, ArcCosine, IsListedSymbol, ExecOffset, Cosine, DateValue, Array_Sort, Log, JulianToDate, FracPortion, Array_SetMaxIndex, Text, SetBarBack, FilledEntryTime, GetFieldStartOffset, MaxBarsBack, DateToJulian, Neg, TimeAdd, Cover, UserID, AbsValue, NthMaxList, IntPortion, IsMarketPrice, FilledEntryDate, StrTrim, CoTangent, MaxList2, Power, Playsound, MilliSecond, SumList, Sine, CurrentTime, Alert, GetField, SetBarMode, Symbol, SetOutputName, SquareRoot, Short, SetAlign, FilledRecordDate, File, GroupSize, BarAdjusted, StrSplit, MaxList, WeekOfMonth, GetSymbolInfo, GetFirstBarDate]
...
> 包含子分類：Factorial, GetBackBar, FilledAvgPrice, UpperStr, GetFieldPublishDate, CurrentBar, TimeValue, FilledRecordCount, IsLastBar, MidStr, FilledRecordIsRealtime, Combination, Buy, FilledRecordPrice, SetFirstBarDate, SetBackBar, WeekOfYear, TimeToString, Array_Sort2d, Tangent, SetBarFreq, GetSymbolFieldStartOffset, CallFunction, GetSymbolGroup, Year, FilledRecordTime, CurrentDate, FormatDate, GetSymbolField, GetSymbolFieldDate, Array_GetMaxIndex, SymbolExchange, AddSpread, Array_SetValRange, GetTotalBar, DateAdd, Permutation, EncodeDate, GetBarBack, Random, DataAlign, StrCompare, DefaultBuyPrice, NoPlot, StrLen, Square, GetTBMode, Tan, LeftStr, SetTBMode, MinList2, RaiseRunTimeError, BarInterval, SetPlotLabel, ArcTangent, FilledRecordQty, DayOfWeek, Sign, ExpValue, GetBarOffset, LowerStr, DefaultSellPrice, NthMinList, EncodeTime, Array_Compare, IsSessionLastBar, InStr, Minute, Plot, Market, PlotLine, AvgList, NumToStr, Position, StringToDate, OutputField, FilledAtBroker, SetRemoveOutlier, PlotFill, CurrentTimeMS, DateDiff, Sin, FormatTime, Second, CheckSymbolField, Array_GetType, GetQuote, StringToTime, SymbolType, StrEndWith, ArcSine, DateToString, CancelAllOrders, SymbolName, SetPosition, IsFirstCall, Mod, FilledRecordTimeMS, IsSessionFirstBar, Floor, Filled, MinList, Round, Sell, GetFieldDate, StrToNum, TimeDiff, Hour, Month, BarFreq, Array_Sum, StrStartWith, Array_Copy, Ceiling, DayOfMonth, Cos, Pos, GetInfo, SetInputName, IsSupportField, SetTotalBar, Print, PlotK, FilledEntryTimeMS, RightStr, CheckField, FilledRecordBS, IsSupportSymbolField, ArcCosine, IsListedSymbol, ExecOffset, Cosine, DateValue, Array_Sort, Log, JulianToDate, FracPortion, Array_SetMaxIndex, Text, SetBarBack, FilledEntryTime, GetFieldStartOffset, MaxBarsBack, DateToJulian, Neg, TimeAdd, Cover, UserID, AbsValue, NthMaxList, IntPortion, IsMarketPrice, FilledEntryDate, StrTrim, CoTangent, MaxList2, Power, Playsound, MilliSecond, SumList, Sine, CurrentTime, Alert, GetField, SetBarMode, Symbol, SetOutputName, SquareRoot, Short, SetAlign, FilledRecordDate, File, GroupSize, BarAdjusted, StrSplit, MaxList, WeekOfMonth, GetSymbolInfo, GetFirstBarDate
