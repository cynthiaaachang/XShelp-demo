...
title: XS完整手冊 - 系統函數
category: 系統函數
tags: [XS語法, 系統函數, VPT, LinearReg, CloseY, WeightedClose, ADI, EMA, xf_XAverage, HighY, Bias, CoefficientR, MI, xfMin_EMA, EMP, Stochastic, BSDelta, OpenQ, xf_GetBoolean, Summation, NthHighest, MO, LowestBar, xf_EMA, xfMin_GetDTValue, SimpleLowestBar, TSELSindex, DiffBidAskVolumeXL, ATR, TrueAll, CloseD, HighQ, DIF, CrossUnder, WMA, BarsLast, NDaysAngle, EnterMarketCloseTime, Filter, NthHighestArray, xf_MACD, LowM, SAR, TSEMFI, xfMin_MACD, IVolatility, HighDays, TrueCount, calcvwapdistribution, MTM_MA, NthLowestBar, BSVega, IFF, xfmin_MTM, CloseM, RSquare, Angle, StandardDev, NthExtremesArray, IsXOrder, MTM, xf_PercentR, LowY, HighestArray, Covariance, TimeSeriesForecast, HL_Osc, xfMin_GetBoolean, MA_Osc, AverageIF, DownTrend, VA, xfMin_WeightedClose, xfMin_CrossOver, NthLowest, KO成交量擺盪指標, GetBarOffsetForYears, TrueAny, FastLowest, HighW, LowH, xf_Stochastic, ReadTicks, NORMSDIST, KeltnerMA, DirectionMovement, xfMin_GetCurrentBar, AvgPrice, Momentum, SimpleHighest, xf_RSI, BSTheta, xfMin_DirectionMovement, LinearRegSlope, TypicalPrice, DiffUpDownVolume, D_Value, DaysToExpirationTF, AR, CloseQ, xfMin_RSI, HighestBar, PSY, LowD, xfMin_CrossUnder, Extremes, ArrayXDaySeries, SimpleLowest, HighM, CloseH, FastLowestBar, OpenD, K_Value, SimpleHighestBar, Q指標, KeltnerUB, MoM, FastHighest, TurnOverRate, OpenM, ADO, ArraySeries, Lowest, VAO, Average, QoQ, ArrayLinearRegSlope, RC, BollingerBandWidth, HighH, OpenY, DateTime, SwingHighBar, SwingLowBar, LowW, LinearRegAngle, RateOfChange, KST確認指標, SwingLow, LowDays, CloseW, VVA, xf_GetCurrentBar, TechScore, LastDayOfMonth, NthLowestArray, DiffBidAskVolumeLxL, BollingerBand, LowestArray, FastHighestBar, HighD, blackscholesmodel, DiffTradeVolumeAtAskBid, xf_CrossOver, xf_DirectionMovement, RSI, OHLCPeriodsAgo, BSPrice, xf_GetValue, UpLimit, ERC, TrueHigh, RSV, angleprice, NthDayofMonth, HVolatility, IsXLOrder, GetLastTradeDate, CommodityChannel, VariancePS, OpenW, UpTrend, BiasDiff, CountIfARow, SwingHigh, CountIf, ArrayMASeries, DwLimit, BR, KeltnerLB, VHF, formatMQY, xf_CrossUnder, CrossOver, YoY, xfMin_Stochastic, CCI, SummationIf, PercentR, BSGamma, Correlation, OpenH, NthHighestBar, xf_WeightedClose, Highest, DPO, MAM, TrueLow, MACD, DMO, AvgDeviation, WAD, xfMin_GetValue, xfMin_XAverage, xf_GetDTValue, LowQ, ACC, xfMin_PercentR, PercentB, ExtremesArray, TrueRange, XAverage, Range, TRIX, NthExtremes, VR, UpShadow, DaysToExpiration]
...
> 包含子分類：VPT, LinearReg, CloseY, WeightedClose, ADI, EMA, xf_XAverage, HighY, Bias, CoefficientR, MI, xfMin_EMA, EMP, Stochastic, BSDelta, OpenQ, xf_GetBoolean, Summation, NthHighest, MO, LowestBar, xf_EMA, xfMin_GetDTValue, SimpleLowestBar, TSELSindex, DiffBidAskVolumeXL, ATR, TrueAll, CloseD, HighQ, DIF, CrossUnder, WMA, BarsLast, NDaysAngle, EnterMarketCloseTime, Filter, NthHighestArray, xf_MACD, LowM, SAR, TSEMFI, xfMin_MACD, IVolatility, HighDays, TrueCount, calcvwapdistribution, MTM_MA, NthLowestBar, BSVega, IFF, xfmin_MTM, CloseM, RSquare, Angle, StandardDev, NthExtremesArray, IsXOrder, MTM, xf_PercentR, LowY, HighestArray, Covariance, TimeSeriesForecast, HL_Osc, xfMin_GetBoolean, MA_Osc, AverageIF, DownTrend, VA, xfMin_WeightedClose, xfMin_CrossOver, NthLowest, KO成交量擺盪指標, GetBarOffsetForYears, TrueAny, FastLowest, HighW, LowH, xf_Stochastic, ReadTicks, NORMSDIST, KeltnerMA, DirectionMovement, xfMin_GetCurrentBar, AvgPrice, Momentum, SimpleHighest, xf_RSI, BSTheta, xfMin_DirectionMovement, LinearRegSlope, TypicalPrice, DiffUpDownVolume, D_Value, DaysToExpirationTF, AR, CloseQ, xfMin_RSI, HighestBar, PSY, LowD, xfMin_CrossUnder, Extremes, ArrayXDaySeries, SimpleLowest, HighM, CloseH, FastLowestBar, OpenD, K_Value, SimpleHighestBar, Q指標, KeltnerUB, MoM, FastHighest, TurnOverRate, OpenM, ADO, ArraySeries, Lowest, VAO, Average, QoQ, ArrayLinearRegSlope, RC, BollingerBandWidth, HighH, OpenY, DateTime, SwingHighBar, SwingLowBar, LowW, LinearRegAngle, RateOfChange, KST確認指標, SwingLow, LowDays, CloseW, VVA, xf_GetCurrentBar, TechScore, LastDayOfMonth, NthLowestArray, DiffBidAskVolumeLxL, BollingerBand, LowestArray, FastHighestBar, HighD, blackscholesmodel, DiffTradeVolumeAtAskBid, xf_CrossOver, xf_DirectionMovement, RSI, OHLCPeriodsAgo, BSPrice, xf_GetValue, UpLimit, ERC, TrueHigh, RSV, angleprice, NthDayofMonth, HVolatility, IsXLOrder, GetLastTradeDate, CommodityChannel, VariancePS, OpenW, UpTrend, BiasDiff, CountIfARow, SwingHigh, CountIf, ArrayMASeries, DwLimit, BR, KeltnerLB, VHF, formatMQY, xf_CrossUnder, CrossOver, YoY, xfMin_Stochastic, CCI, SummationIf, PercentR, BSGamma, Correlation, OpenH, NthHighestBar, xf_WeightedClose, Highest, DPO, MAM, TrueLow, MACD, DMO, AvgDeviation, WAD, xfMin_GetValue, xfMin_XAverage, xf_GetDTValue, LowQ, ACC, xfMin_PercentR, PercentB, ExtremesArray, TrueRange, XAverage, Range, TRIX, NthExtremes, VR, UpShadow, DaysToExpiration
